({ "163.com":{ _name:"网易公开课",
    ds:[ { title:"用户发帖",
        docs:"https://moeyy.cn/rsshub/routes/game",
        source:[ "/user/:id" ],
        target:"/163/ds/:id" } ],
    "3g":[ { title:"栏目",
        docs:"https://moeyy.cn/rsshub/routes/new-media",
    ...
    "wp.m":[ { title:"今日关注",
        ...
        target:"/163/today" } ],
    "vip.open":[ { title:"精品课程",
        docs:"https://moeyy.cn/rsshub/routes/study",
        source:[ "/" ],
        target:"/163/open/vip" } ] },
  "12306.cn":{ _name:"12306",
    www:[ { title:"最新动态",
        docs:"https://moeyy.cn/rsshub/routes/travel",
        source:[ "/",
          "/mormhweb/1/:id/index_fl.html" ],
        target:"/12306/zxdt/:id" } ] },
  "12371.cn":{ _name:"共产党员网",
    www:[ { title:"最新发布",
        docs:"https://moeyy.cn/rsshub/routes/government",
        source:[ "/:category" ],
        target:"/12371/:category?" } ] },
  "005.tv":{ _name:"幻之羁绊动漫网",
    ".":[ { title:"资讯",
        docs:"https://moeyy.cn/rsshub/routes/anime",
        source:[ "/:category" ],
  ...
  "50forum.org.cn":{ _name:"经济 50 人论坛",
    ".":[ { title:"Unknown",
        docs:"https://moeyy.cn/rsshub/routes/other",
        source:[ "/home/article/index/category/zhuanjia.html",
          "/" ],
        target:"/50forum/" } ] },
  "51cto.com":{ _name:"51CTO",
    ".":[ { title:"推荐",
        docs:"https://moeyy.cn/rsshub/routes/programming",
        source:[ "/" ],
  ...
  "8kcosplay.com":{ _name:"8KCosplay",
    ".":[ { title:"Unknown",
        docs:"https://moeyy.cn/rsshub/routes/picture",
        source:[ "/" ],
  ...
  "abc.net.au":{ _name:"ABC News",
    ".":[ { title:"Channel & Topic",
        docs:"https://moeyy.cn/rsshub/routes/traditional-media",
        source:[ "/:category*" ],
        target:"/abc/:category" } ] },
  ...
  "aeaweb.org":{ _name:"American Economic Association",
    ".":[ { title:"Journal",
        docs:"https://moeyy.cn/rsshub/routes/journal",
        source:[ "/journals/:id",
          "/" ],
        target:"/aeaweb/:id" } ] },
  "aeon.co":{ _name:"AEON",
  ...
  "github.io":{ _name:"AG⓪RA",
    ...
    njuferret:[ { title:"Blogs",
        docs:"https://moeyy.cn/rsshub/routes/blog",
        source:[ "/" ],
        target:"/njuferret/blog" } ] },
  "ahjzu.edu.cn":{ _name:"安徽建筑大学",
    news:[ { title:"通知公告",
        docs:"https://moeyy.cn/rsshub/routes/university",
        source:[ "/20/list.htm" ],
        target:"/ahjzu/news" } ] },
  "ainvest.com":{ _name:"AInvest",
    ".":[ { title:"Latest Article",
        docs:"https://moeyy.cn/rsshub/routes/finance",
        source:[ "/news" ],
  ...
  "android.com":{ _name:"Android",
    developer:[ { title:"SDK Platform Tools release notes",
        docs:"https://moeyy.cn/rsshub/routes/program-update",
  ...
  "arcteryx.com":{ _name:"Arcteryx",
    ".":[ { title:"New Arrivals",
        docs:"https://moeyy.cn/rsshub/routes/shopping",
  ...
  "bilibili.com":{ _name:"Bilibili",
    space:[ { title:"UP 主专栏",
        docs:"https://moeyy.cn/rsshub/routes/social-media",
        source:[ "/:uid" ],
    ...
    live:[ { title:"直播开播",
        docs:"https://moeyy.cn/rsshub/routes/live",
        source:[ "/:roomID" ],
  ...
  "bmkg.go.id":{ _name:"BADAN METEOROLOGI, KLIMATOLOGI, DAN GEOFISIKA(Indonesian)",
    ".":[ { title:"Recent Earthquakes",
        docs:"https://moeyy.cn/rsshub/routes/forecast",
        source:[ "/",
  ...
  "ciweimao.com":{ _name:"刺猬猫",
    wap:[ { title:"章节",
        docs:"https://moeyy.cn/rsshub/routes/reading",
        source:[ "/book/:id" ],
  ...
  "dribbble.com":{ _name:"Dribbble",
    ".":[ { title:"Popular",
        docs:"https://moeyy.cn/rsshub/routes/design",
        source:[ "/" ],
