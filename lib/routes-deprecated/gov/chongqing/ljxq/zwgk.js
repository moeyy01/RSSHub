...
module.exports = async (ctx) => {
    ...
    if (!cfg) {
        throw new Error('Bad category. See <a href="https://moeyy.cn/rsshub/routes/government#zhong-qing-shi-ren-min-zheng-fu-liang-jiang-xin-qu-xin-xi-gong-kai-wang-zheng-wu-gong-kai">docs</a>');
    }
