...
module.exports = async (ctx) => {
    ...
    if (!cfg) {
        throw new Error('Bad category. See <a href="https://moeyy.cn/rsshub/routes/government#guang-dong-sheng-ren-min-zheng-fu-guang-dong-sheng-jiao-yu-kao-shi-yuan">docs</a>');
    }
