...
async function handler(ctx) {
    if (!config.mihoyo.cookie) {
        throw new ConfigNotFoundError('Miyoushe Timeline is not available due to the absense of [Miyoushe Cookie]. Check <a href="https://moeyy.cn/rsshub/deploy/config#route-specific-configurations">relevant config tutorial</a>');
    }
