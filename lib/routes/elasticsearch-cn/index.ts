...
export const route: Route = {
    ...
    maintainers: ['nczitzk'],
    handler,
    description: `如 [Elasticsearch 最新](https://elasticsearch.cn/category-2) 的 URL 为 \`https://elasticsearch.cn/category-2\`，则分类参数处填写 \`category-2\`，最后得到路由地址 [\`/elasticsearch-cn/category-2\`](https://rsshub.moeyy.xyz/elasticsearch-cn/category-2)。
