...
async function handler(ctx) {
    ...
    if (!cfg) {
        throw new InvalidParameterError('Bad category. See <a href="https://moeyy.cn/rsshub/routes/new-media#it-zhi-jia">https://moeyy.cn/rsshub/routes/new-media#it-zhi-jia</a>');
    }
