...
async function handler(ctx) {
    ...
    if (!id) {
        throw new InvalidParameterError('Bad type. See <a href="https://moeyy.cn/rsshub/routes/new-media#it-zhi-jia">https://moeyy.cn/rsshub/routes/new-media#it-zhi-jia</a>');
    }
