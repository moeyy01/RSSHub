...
async function handler(ctx) {
    if (!config.notion.key) {
        throw new ConfigNotFoundError('Notion RSS is disabled due to the lack of NOTION_TOKEN(<a href="https://moeyy.cn/rsshub/deploy/config#route-specific-configurations">relevant config</a>)');
    }
