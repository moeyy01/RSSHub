...
async function handler(ctx) {
    if (!config.hefeng.key) {
        throw new ConfigNotFoundError('QWeather RSS is disabled due to the lack of <a href="https://moeyy.cn/rsshub/zh/install/config#%E5%92%8C%E9%A3%8E%E5%A4%A9%E6%B0%94">relevant config</a>');
    }
