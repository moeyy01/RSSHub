...
async function handler(ctx) {
    ...
    if (!cfg) {
        throw new InvalidParameterError('Bad category. See <a href="https://moeyy.cn/rsshub/routes/new-media#wang-yi-xin-wen-pai-hang-bang">docs</a>');
    } else if ((category !== 'whole' && type === 'click' && time === 'month') || (category === 'whole' && type === 'click' && time === 'hour') || (type === 'follow' && time === 'hour')) {
        throw new InvalidParameterError('Bad timeRange range. See <a href="https://moeyy.cn/rsshub/routes/new-media#wang-yi-xin-wen-pai-hang-bang">docs</a>');
    }
