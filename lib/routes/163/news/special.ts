...
async function handler(ctx) {
    if (!ctx.req.param('type')) {
        throw new InvalidParameterError('Bad parameter. See <a href="https://moeyy.cn/rsshub/routes/game#wang-yi-da-shen">https://moeyy.cn/rsshub/routes/game#wang-yi-da-shen</a>');
    }
