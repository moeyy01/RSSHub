...
async function handler(ctx) {
    ...
    if (!cfg) {
        throw new InvalidParameterError('Bad category. See <a href="https://moeyy.cn/rsshub/routes/government#guang-dong-sheng-ren-min-zheng-fu-shen-zhen-shi-zhu-fang-he-jian-she-ju">docs</a>');
    }
