...
async function handler(ctx) {
    ...
    if (!cfg) {
        throw new InvalidParameterError('Bad category. See <a href="https://moeyy.cn/rsshub/routes/government#guang-dong-sheng-ren-min-zheng-fu-guang-dong-sheng-shen-zhen-shi-ren-min-zheng-fu">docs</a>');
    }
