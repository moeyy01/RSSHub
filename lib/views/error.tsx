...
const Index: FC<{
    ...
    <Layout>
            ...
            <div className="text-left w-[800px] space-y-6 !mt-10">
                ...
                {/* <div>
                    ...
                    <p>
                        ...
                        <a className="text-[#F5712C]" href="https://moeyy.cn/rsshub/" target="_blank">
                            document
                        </a>
                    ...
                    <p>
                        在仔细阅读
                        <a className="text-[#F5712C]" href="https://moeyy.cn/rsshub/zh/" target="_blank">
                            文档
                        </a>
        ...
        {/* <div className="absolute bottom-10 text-center w-full text-sm font-medium space-y-2">
            ...
            <p className="!mt-6">
                Please consider{' '}
                <a target="_blank" href="https://moeyy.cn/rsshub/sponsor" className="text-[#F5712C]">
                    sponsoring
                </a>{' '}
